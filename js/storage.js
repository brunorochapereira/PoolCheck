const PoolStore=(()=>{
 ...
 const defaults={version:3,onboardingComplete:false,pool:{name:'Piscina principal',type:'enterrada',volume:36,treatment:'cloro',hasCover:false,highTempThreshold:28},weather:{enabled:true,autoTasks:true,latitude:null,longitude:null,temperature:null,updatedAt:null,timezone:null,daily:[],impact:null},maintenance:[{id:'pump-prefilter',title:'Limpar pré-filtro da bomba',lastDone:null,intervalDays:7},{id:'filter',title:'Verificar e limpar o filtro',lastDone:null,intervalDays:7},{id:'backwash',title:'Fazer backwash',lastDone:null,intervalDays:7},{id:'robot',title:'Aspirar com o robô',lastDone:null,intervalDays:7}],notificationsEnabled:false,lastMaintenanceNotification:null,analyses:[],activePlan:null,lastCompletedPlan:null};
